...
export const ME_ROUTE = "/api/v1/users/me";
export const SIGN_IN_ROUTE = "/api/v1/auth/sign-in/email";
...
export const PROVISIONED_PASSWORD = "Provisioned123";

export const UNKNOWN_USER_ID = "00000000-0000-4000-8000-000000000000";
