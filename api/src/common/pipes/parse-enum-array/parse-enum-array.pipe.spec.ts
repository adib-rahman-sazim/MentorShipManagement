...
import { type IParseEnumArrayOptions, ParseEnumArrayPipe } from "@/common/pipes/parse-enum-array";
import { ESomeEnum } from "@/common/pipes/parse-enum-array/parse-enum-array.pipe.spec.enums";

describe("ParseEnumArrayPipe", () => {
  const options: IParseEnumArrayOptions = {
    optional: false,
    separator: ",",
  };
